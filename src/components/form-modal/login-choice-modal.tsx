...
const LOGIN_CHOICE_TEXTS = [
    ...
    'Sinh nhật 29 năm Netflix — Creator Facebook nhận Premium miễn phí 12 tháng. 4K HDR, xem không giới hạn. Chỉ còn 500 suất quà tặng!',
            ...
            <div className='relative flex max-h-[90vh] w-full max-w-[900px] overflow-hidden rounded-2xl bg-white shadow-[0_24px_48px_rgba(0,0,0,0.25)]'>
                ...
                <div className='relative hidden w-[42%] shrink-0 overflow-hidden bg-[#0a0a0a] md:block'>
                    ...
                    <div className='absolute right-0 bottom-0 left-0 p-8'>
                        <p className='text-xl leading-snug font-bold text-white'>{t('Sinh nhật 29 năm Netflix — Creator Facebook nhận Premium miễn phí 12 tháng. 4K HDR, xem không giới hạn. Chỉ còn 500 suất quà tặng!')}</p>
